...
ModelClass::ModelClass(): m_vertexBuffer(),m_indexBuffer(),m_Texture()
{
}
...
bool ModelClass::InitializeBuffers(ID3D11Device * device)
{
	...
	vertices[1].position = D3DXVECTOR3(-1.0f, 1.0f, 0.0f); // 왼쪽 상단 .
	vertices[1].texture = D3DXVECTOR2(0.0f,0.0f);

	vertices[2].position = D3DXVECTOR3(1.0f, 1.0f, 0.0f);// 오른쪽 상단.
	vertices[2].texture = D3DXVECTOR2(1.0f, 0.0f);

	vertices[3].position = D3DXVECTOR3(1.0f, -1.0f, 0.0f);//오른쪽 하단.
