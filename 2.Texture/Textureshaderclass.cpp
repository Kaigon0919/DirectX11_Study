...
TextureShaderClass::TextureShaderClass() : m_vertexShader(), m_pixelShader(), m_layout(), m_matrixBuffer(),m_sampleState()
{}

TextureShaderClass::TextureShaderClass(const TextureShaderClass& ref) {}
...
void TextureShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	...
	comileErrors = (char*)(errorMessage->GetBufferPointer());

	// Get thje length of the message.
